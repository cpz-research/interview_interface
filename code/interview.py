...
if st.session_state.consent_given is None:
    ...
    st.markdown(
        ...
        Some of the questions you’ll see were written by researchers, while follow-up questions 
        are generated by AI based on your responses.<br><br>
        This is only a <b>technical test</b>, and we’re not evaluating the content of your answers.<br><br>
...
elif "interview_selected" not in st.session_state:
    st.session_state.interview_selected = None

if st.session_state.consent_given and st.session_state.interview_selected is None:
