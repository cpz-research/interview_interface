...
if st.session_state.consent_given is None:
    ...
    st.markdown(
        ...
        <b>Note:</b> This questionnaire will be addressed to <b>mothers with children</b> between 0 and 16 years old. If this does not apply to you, please complete it as if it does.<br><br>
